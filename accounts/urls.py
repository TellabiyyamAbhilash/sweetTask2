...
from accounts.views import patient_register,doctor_login_request,logout_view,doctor_details,patient_details,patient_login_request,addblog,showblogs,blogDetail
urlpatterns=[
